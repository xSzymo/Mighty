...
public class ChampionPointsManagerTest_1 extends AuthorizationConfiguration {
    @Autowired
    ...
    public void addPoints_not_enough_money() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.MAGIC_RESIST, champion.getId(), 2);
    }
    ...
    public void addPoints_magicResist_three_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.MAGIC_RESIST, champion.getId(), 3);
    ...
    public void addPoints_armor_two_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.ARMOR, champion.getId(), 2);
    ...
    public void addPoints_armor_three_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.ARMOR, champion.getId(), 3);
    ...
    public void addPoints_strength_two_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.STRENGTH, champion.getId(), 2);
    ...
    public void addPoints_strength_three_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.STRENGTH, champion.getId(), 3);
    ...
    public void addPoints_intelligence_two_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.INTELLIGENCE, champion.getId(), 2);
    ...
    public void addPoints_intelligence_three_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.INTELLIGENCE, champion.getId(), 3);
    ...
    public void addPoints_vitality_two_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.VITALITY, champion.getId(), 2);
    ...
    public void addPoints_vitality_three_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.VITALITY, champion.getId(), 3);
    ...
    public void addPoints_criticalChance_two_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.CRITICAL_CHANCE, champion.getId(), 2);
    ...
    public void addPoints_criticalChance_three_time() throws Exception {
        ...
        championPointsManager.addPoints(token, StatisticType.CRITICAL_CHANCE, champion.getId(), 3);
